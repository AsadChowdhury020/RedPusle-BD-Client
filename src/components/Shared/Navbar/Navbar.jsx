...
//   <>
//     <li>
//       <NavLink className={navItemClasses} to={"/"}>Home</NavLink>
//     </li>
//     <li>
//       <NavLink className={navItemClasses} to={"/donation-requests"}>Donation Requests</NavLink>
//     </li>
//     <li>
//       <NavLink className={navItemClasses} to={"/funding"}>Funding</NavLink>
//     </li>
//     <li>
//       <NavLink className={navItemClasses} to={"/search"}>Search</NavLink>
//     </li>
//     <li>
//       <NavLink className={navItemClasses} to={"/blogs"}>Blogs</NavLink>
//     </li>
//     <li>
//       <NavLink className={navItemClasses} to={"/about-us"}>About Us</NavLink>
//     </li>
//   </>
// );
